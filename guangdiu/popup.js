...
var loadStr='http://guangdiu.com/api/crgetdata.php?ver='+currentversion+'&v='+timeStr+'&p=';
...
var loadMaxid='http://guangdiu.com/api/getmaxid.php';
...
$("#abroadtab").click(function(){
		loadStr='http://guangdiu.com/api/crgetdata.php?ver='+currentversion+'&c=us&v='+timeStr+'&p=';
		currentPage=1;
		$("#loadmore").hide();
		$("#loading").show();
		$.get(loadStr+currentPage, function(data){
...
$("#hometab").click(function(){
		loadStr='http://guangdiu.com/api/crgetdata.php?ver='+currentversion+'&v='+timeStr+'&p=';
		currentPage=1;
		$("#loadmore").hide();
		$("#loading").show();
		$.get(loadStr+currentPage, function(data){
...
$("#ranktab").click(function(){
		loadStr='http://guangdiu.com/api/crgetrank.php?ver='+currentversion+'&v='+timeStr+'&p=';
		currentPage=1;
		$("#loadmore").hide();
		$("#loading").show();
		$.get(loadStr+currentPage, function(data){
